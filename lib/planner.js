...
function generateRowColumnLoop(oType, aType, bType, useAlpha, useBeta) {
  ...
  code.push.apply(code, start(aOrd, "a", aType))
  code.push.apply(code, start(bOrd, "b", bType))
  ...
  if(oOrd[1]) {
    code.push.apply(code, walk(aOrd, "a", aType, 1, "i"))
  } else {
